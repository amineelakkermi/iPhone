...
const HowItWorks = () => {
  ...
  return (
    ...
    <div className='screen-max-width'>
     ...
     It's here. The biggest redesign in the histiry Apple GPUs.
     </p>
     </div>
     ...
     <div className='mt-10 md:mt-20 mb-14'>
      ...
      <p className='text-gray font-semibold text-center mt-3'>Honjai: Star Rail</p>
      </div>
      <div className='hiw-text-container'>
          <div className='flex flex-1 justify-center flex-col'>
            ...
            <p className='hiw-text g_fadeIn'>
                ...
                with incredibly detailed envirenments and characters.
            </p>
          </div>
